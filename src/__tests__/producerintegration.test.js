...
// beforeAll(async () => {
//   await uploadSchema(`${topic}-value`, require('../__mocks__/schema1.json'))
//   await uploadSchema(
//     `${hlTopic}-value`,
//     require('../__mocks__/highlight-value.json'),
//   )
//   await uploadSchema(
//     `${hlTopic}-key`,
//     require('../__mocks__/highlight-key.json'),
//   )
...
//   const producerApiConfig = _.assign({}, config, {
//     kafka: { producer: config.producer, avro: config.avro },
//   })

//   const producerApi = await applyMagic(logger, schemaSets, producerApiConfig)
//   await producerApi.start()

//   afterAll(async () => {
//     await producerApi.stop()
//   })
// })

// describe.only('The avro mongodb api tests', done => {
...
//       topic,
//       avro: config.avro,
//       producer: config.consumer,
//     })

//     consumer.once('data', data => {
