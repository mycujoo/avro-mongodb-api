...
//   const consumerApiConfig = _.assign({}, config, {
//     kafka: { consumer: config.consumer, avro: config.avro },
//   })

//   const consumerApi = await applyMagic(logger, schemaSets, consumerApiConfig)
//   await consumerApi.start()

//   afterAll(async () => {
//     await consumerApi.stop()
//   })
// })
